...
class MySuratCard extends StatelessWidget {
  ...
  final VoidCallback? onTap; // Untuk tap pada seluruh card
  ...
  const MySuratCard({
    ...
    // Tambahkan parameter dengan nilai default
    this.tujuanSurat = "-",
    this.nomorAgenda = "",
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                ...
                                // Tambahkan tanda panah untuk menunjukkan aliran surat
                                const Text(
                                  '→',
                                  style: TextStyle(
                                    color: AppPallete.textColor,
                          ...
                          showModalBottomSheet(
                            ...
                            builder: (context) => Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  // Detail option - now uses onTap for navigation
                                  ListTile(
                                    leading: const Icon(Icons.visibility),
                                    title: const Text('Detail'),
                                    onTap: () {
                                      Navigator.pop(context); // Close bottom sheet
                                      // Use the same onTap callback as the card itself
                                      if (onTap != null) {
                                        onTap!();
                                      }
                                    },
