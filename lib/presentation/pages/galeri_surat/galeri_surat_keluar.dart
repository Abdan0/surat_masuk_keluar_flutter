...
class _GaleriSuratKeluarState extends State<GaleriSuratKeluar> {
  ...
  final List<FileData> _files = [
    FileData(
      id: 'SK-001',
      title: 'Surat Pemberitahuan Kegiatan',
      fileType: 'PDF',
      fileUrl: '/path/to/file1.pdf',
    ),
    FileData(
      id: 'SK-002',
      title: 'Surat Undangan Pelatihan',
      fileType: 'PDF',
    ...
    FileData(
      id: 'SK-004',
      title: 'Surat Persetujuan Anggaran',
      fileType: 'PDF',
      fileUrl: '/path/to/file4.pdf',
    ),
    FileData(
      id: 'SK-005',
      title: 'Surat Keterangan Aktif Organisasi',
      fileType: 'DOCX',
      fileUrl: '/path/to/file5.docx',
    ),
    FileData(
      id: 'SK-006',
      title: 'Surat Penugasan Karyawan',
      fileType: 'XLS',
